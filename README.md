...
- S21：21点Q4覆盖通过3832单元整数四叉树证书和独立检查，路线17908.930 m（S25为18173.851 m，-1.46%）。两组独立50对本地严格配对中问题4降低3.45%-4.66%（p<1e-4），聚集/边缘/最小半径/朝外定向压力场景各20对降低2.77%-4.40%，全部清除；官方问题4各10局初步演练全部清除，S21聚合时间/源553.51 s、S25为602.56 s，平均低约6.13%但Mann-Whitney p=0.734，尚不足以确认分布优势。
