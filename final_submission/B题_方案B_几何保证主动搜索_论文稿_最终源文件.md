...
7. Q1可实现反例、Q2条件候选区与817.749 m连续最坏距离、Q3边界网格缺口和Q4局部凸包证书均已审计；Oracle上下界给出每源不超过7.75秒的知情差距范围。完整滚动版在修复后仍未优于G25OR，只能说明该实现无额外收益，不能说明调度空间已经饱和；G21A零绕行补测原型在六类场景N=10..16的1260次运行矩阵中总体慢3.68%，全部清除但未达淘汰门槛，已停止。
