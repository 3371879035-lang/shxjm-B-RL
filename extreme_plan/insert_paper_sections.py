...
old='### 10.7 正式测试方案与记录表'
assert old in t
t=t.replace(old,'### 10.7 正式测试方案与记录表',0)  # no-op anchor
new_secs=(base.parent/'extreme_plan'/'new_sections.md').read_text(encoding='utf-8')
assert '### 10.11 正式测试方案与记录表' in new_secs
